function [ train_res, test_res ] = caffe_log_proc2( log_filename )
%% Description
...
%             fprintf('%s : accuracy_test_val = %f \n', mfilename, accuracy_val);
            ...
            line_i = line_i+1; %Skipping the next 1 lines
            
        else % These are training results since testing words was not found
